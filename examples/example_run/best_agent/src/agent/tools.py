...
def _validate_python_content(path: str, content: str) -> str | None:
    ...
    prose_starters = [
        'here is', 'here\'s', 'the following', 'this file', 'this code',
        'below is', 'i have', 'i\'ve', 'the solution', 'the code',
        'all tests', 'tests pass', 'test pass',
    ]
    ...
    try:
        ...
        if name == "search_files":
            ...
            result = subprocess.run(
                ["grep", "-rn", f"--include={include_pattern}",
