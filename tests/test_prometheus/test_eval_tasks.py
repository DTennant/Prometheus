...
from prometheus.eval.tasks.code_generation import get_code_generation_tasks, FibonacciTask
from prometheus.eval.tasks.file_manipulation import (
    get_file_manipulation_tasks,
    FindAndReplaceTask,
)
from prometheus.eval.tasks.debugging import get_debugging_tasks, OffByOneTask
